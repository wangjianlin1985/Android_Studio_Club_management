...
public class HuodongStListActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		search.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				//intent.setClass(HuodongStListActivity.this, HuodongQueryActivity.class);
		...
		add_btn.setOnClickListener(new android.view.View.OnClickListener(){ 
			...
			public void onClick(View arg0) {
				Intent intent = new Intent();
				intent.setClass(HuodongStListActivity.this, HuodongStAddActivity.class);
				startActivityForResult(intent,ActivityUtils.ADD_CODE);
			}
		});
		
		queryConditionHuodong = new Huodong();
		queryConditionHuodong.setHuodongName("");
		queryConditionHuodong.setHuodongTime(null);
		queryConditionHuodong.setShetuanObj(username);
	...
	private void setViews() {
		...
		new Thread(){
			...
			public void run() {
				...
				handler.post(new Runnable() {
					...
					public void run() {
						dialog.cancel();
						adapter = new HuodongSimpleAdapter(HuodongStListActivity.this, list,
		...
		lv.setOnItemClickListener(new OnItemClickListener(){
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,long arg3) {
            	...
            	Intent intent = new Intent();
            	intent.setClass(HuodongStListActivity.this, HuodongDetailActivity.class);
	...
	private OnCreateContextMenuListener huodongListItemListener = new OnCreateContextMenuListener() {
		public void onCreateContextMenu(ContextMenu menu, View v,ContextMenuInfo menuInfo) {
			menu.add(0, 0, 0, "删除社团活动信息"); 
			//menu.add(0, 1, 0, "删除社团活动");
		}
	};
	...
	protected void dialog() {
		Builder builder = new Builder(HuodongStListActivity.this);
