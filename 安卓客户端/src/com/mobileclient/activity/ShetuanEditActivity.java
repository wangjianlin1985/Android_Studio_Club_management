...
public class ShetuanEditActivity extends Activity {
	// 声明确定添加按钮
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// 设置当前Activity界面布局
		setContentView(R.layout.shetuan_edit); 
		ImageView search = (ImageView) this.findViewById(R.id.search);
		search.setVisibility(View.GONE);
		TextView title = (TextView) this.findViewById(R.id.title);
		title.setText("编辑社团信息");
		...
		iv_shetuanPhoto.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				intent.setClass(ShetuanEditActivity.this,photoListActivity.class);
			...
			public void onClick(View v) {
				try {
					...
					if(ET_password.getText().toString().equals("")) {
						Toast.makeText(ShetuanEditActivity.this, "登录密码输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_shetuanName.getText().toString().equals("")) {
						Toast.makeText(ShetuanEditActivity.this, "社团名称输入不能为空!", Toast.LENGTH_LONG).show();
						ET_shetuanName.setFocusable(true);
						ET_shetuanName.requestFocus();
						return;	
					}
					shetuan.setShetuanName(ET_shetuanName.getText().toString());
					if (!shetuan.getShetuanPhoto().startsWith("upload/")) {
						//如果图片地址不为空，说明用户选择了图片，这时需要连接服务器上传图片
						ShetuanEditActivity.this.setTitle("正在上传图片，稍等...");
						String shetuanPhoto = HttpUtil.uploadFile(shetuan.getShetuanPhoto());
						ShetuanEditActivity.this.setTitle("图片上传完毕！");
						shetuan.setShetuanPhoto(shetuanPhoto);
					} 
					/*验证获取社团简介*/ 
					if(ET_shetuanDesc.getText().toString().equals("")) {
						Toast.makeText(ShetuanEditActivity.this, "社团简介输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_fuzeren.getText().toString().equals("")) {
						Toast.makeText(ShetuanEditActivity.this, "负责人输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_telephone.getText().toString().equals("")) {
						Toast.makeText(ShetuanEditActivity.this, "联系电话输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_shetuanMemo.getText().toString().equals("")) {
						Toast.makeText(ShetuanEditActivity.this, "社团备注输入不能为空!", Toast.LENGTH_LONG).show();
					...
					/*调用业务逻辑层上传社团信息*/
					ShetuanEditActivity.this.setTitle("正在更新社团信息，稍等...");
					String result = shetuanService.UpdateShetuan(shetuan);
	...
	private void initViewData() {
		...
		this.TV_stUserName.setText(stUserName);
		this.ET_password.setText(shetuan.getPassword());
		this.ET_shetuanName.setText(shetuan.getShetuanName());
		...
		this.ET_shetuanDesc.setText(shetuan.getShetuanDesc());
		...
		this.ET_fuzeren.setText(shetuan.getFuzeren());
		this.ET_telephone.setText(shetuan.getTelephone());
		this.ET_shetuanMemo.setText(shetuan.getShetuanMemo());
	}
	@Override
