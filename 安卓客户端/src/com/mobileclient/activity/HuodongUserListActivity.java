...
public class HuodongUserListActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		search.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				intent.setClass(HuodongUserListActivity.this, HuodongQueryActivity.class);
		...
		add_btn.setOnClickListener(new android.view.View.OnClickListener(){ 
			...
			public void onClick(View arg0) {
				Intent intent = new Intent();
				intent.setClass(HuodongUserListActivity.this, HuodongAddActivity.class);
	...
	private void setViews() {
		...
		new Thread(){
			...
			public void run() {
				...
				handler.post(new Runnable() {
					...
					public void run() {
						dialog.cancel();
						adapter = new HuodongSimpleAdapter(HuodongUserListActivity.this, list,
		...
		lv.setOnItemClickListener(new OnItemClickListener(){
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,long arg3) {
            	...
            	Intent intent = new Intent();
            	intent.setClass(HuodongUserListActivity.this, HuodongDetailActivity.class);
	...
	public boolean onContextItemSelected(MenuItem item) {
		if (item.getItemId() == 0) {  //编辑社团活动信息
			...
			Intent intent = new Intent();
			intent.setClass(HuodongUserListActivity.this, HuodongEditActivity.class);
			Bundle bundle = new Bundle();
			bundle.putInt("huodongId", huodongId);
			intent.putExtras(bundle);
	...
	protected void dialog() {
		Builder builder = new Builder(HuodongUserListActivity.this);
