...
public class ShetuanUserListActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		search.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				intent.setClass(ShetuanUserListActivity.this, ShetuanQueryActivity.class);
		...
		add_btn.setOnClickListener(new android.view.View.OnClickListener(){ 
			...
			public void onClick(View arg0) {
				Intent intent = new Intent();
				intent.setClass(ShetuanUserListActivity.this, ShetuanAddActivity.class);
	...
	private void setViews() {
		...
		new Thread(){
			...
			public void run() {
				...
				handler.post(new Runnable() {
					...
					public void run() {
						dialog.cancel();
						adapter = new ShetuanSimpleAdapter(ShetuanUserListActivity.this, list,
		...
		lv.setOnItemClickListener(new OnItemClickListener(){
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,long arg3) {
            	...
            	Intent intent = new Intent();
            	intent.setClass(ShetuanUserListActivity.this, ShetuanDetailActivity.class);
	...
	public boolean onContextItemSelected(MenuItem item) {
		if (item.getItemId() == 0) {  //编辑社团信息
			...
			Intent intent = new Intent();
			intent.setClass(ShetuanUserListActivity.this, ShetuanEditActivity.class);
			Bundle bundle = new Bundle();
			bundle.putString("stUserName", stUserName);
			intent.putExtras(bundle);
	...
	protected void dialog() {
		Builder builder = new Builder(ShetuanUserListActivity.this);
