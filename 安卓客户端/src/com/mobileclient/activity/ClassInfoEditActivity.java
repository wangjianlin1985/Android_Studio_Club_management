...
public class ClassInfoEditActivity extends Activity {
			...
			public void onClick(View v) {
				try {
					...
					if(ET_collegeName.getText().toString().equals("")) {
						Toast.makeText(ClassInfoEditActivity.this, "所在学院输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_specialName.getText().toString().equals("")) {
						Toast.makeText(ClassInfoEditActivity.this, "所属专业输入不能为空!", Toast.LENGTH_LONG).show();
	...
	private void initViewData() {
		...
		this.ET_collegeName.setText(classInfo.getCollegeName());
		...
		this.ET_banzhuren.setText(classInfo.getBanzhuren());
	}
	@Override
