...
public class MoreActivity extends Activity {
	private String[] strs = new String[]{"新闻公告","社团信息","关于"};
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if(declare.getIdentify().equals("user"))
			strs = new String[]{"新闻公告","修改个人信息","关于"};
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				if(declare.getIdentify().equals("user")) {
					...
					if(arg2 == 1){
						String user_name = declare.getUserName();
						Intent intent = new Intent();
						intent.setClass(MoreActivity.this, ShetuanEditActivity.class);
						Bundle bundle = new Bundle();
						bundle.putString("stUserName", user_name);
						intent.putExtras(bundle);
						startActivityForResult(intent,ActivityUtils.EDIT_CODE);
					}
					if(arg2 == 2){
