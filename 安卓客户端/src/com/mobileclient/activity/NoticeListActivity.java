...
public class NoticeListActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if(!declare.getIdentify().equals("admin")) add_btn.setVisibility(View.GONE);
	...
	private OnCreateContextMenuListener noticeListItemListener = new OnCreateContextMenuListener() {
		public void onCreateContextMenu(ContextMenu menu, View v,ContextMenuInfo menuInfo) {
			Declare decalre = (Declare) NoticeListActivity.this.getApplication();
			if(decalre.getIdentify().equals("admin")) {
