			...
			public void onClick(View v) {
				try {
					...
					if(ET_huodongName.getText().toString().equals("")) {
						Toast.makeText(HuodongAddActivity.this, "活动名称输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_huodongMemo.getText().toString().equals("")) {
						Toast.makeText(HuodongAddActivity.this, "活动备注输入不能为空!", Toast.LENGTH_LONG).show();
					...
					/*调用业务逻辑层上传社团活动信息*/
					HuodongAddActivity.this.setTitle("正在上传社团活动信息，稍等...");
