				...
				handler.post(new Runnable() {
					...
					public void run() {
						...
						adapter = new ClassInfoSimpleAdapter(ClassInfoListActivity.this, list,
	        					...
	        					new String[] { "classNo","className","collegeName","specialName","bornDate","banzhuren" },
	        					new int[] { R.id.tv_classNo,R.id.tv_className,R.id.tv_collegeName,R.id.tv_specialName,R.id.tv_bornDate,R.id.tv_banzhuren,},lv);
	...
	private List<Map<String, Object>> getDatas() {
		...
		try {
			...
			for (int i = 0; i < classInfoList.size(); i++) {
				...
				map.put("collegeName", classInfoList.get(i).getCollegeName());
				map.put("specialName", classInfoList.get(i).getSpecialName());
				map.put("bornDate", classInfoList.get(i).getBornDate());
				map.put("banzhuren", classInfoList.get(i).getBanzhuren());
				list.add(map);
			}
		} catch (Exception e) { 
