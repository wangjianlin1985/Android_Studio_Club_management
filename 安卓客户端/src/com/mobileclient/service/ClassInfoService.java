...
public class ClassInfoService {
	...
	public String AddClassInfo(ClassInfo classInfo) {
		...
		params.put("collegeName", classInfo.getCollegeName());
		params.put("specialName", classInfo.getSpecialName());
	...
	public List<ClassInfo> QueryClassInfo(ClassInfo queryConditionClassInfo) throws Exception {
		...
		if(queryConditionClassInfo != null) {
			...
			urlString += "&collegeName=" + URLEncoder.encode(queryConditionClassInfo.getCollegeName(), "UTF-8") + "";
			urlString += "&specialName=" + URLEncoder.encode(queryConditionClassInfo.getSpecialName(), "UTF-8") + "";
		}
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				...
				classInfo.setCollegeName(object.getString("collegeName"));
				classInfo.setSpecialName(object.getString("specialName"));
