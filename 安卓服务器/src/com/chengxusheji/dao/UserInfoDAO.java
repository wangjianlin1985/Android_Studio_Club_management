...
public class UserInfoDAO {
    ...
    public ArrayList<UserInfo> QueryUserInfoInfo(String user_name,ClassInfo classObj,String name,String birthDate,String telephone,int currentPage) { 
    	Session s = factory.getCurrentSession();
    ...
    @Transactional(propagation=Propagation.NOT_SUPPORTED)
    public ArrayList<UserInfo> QueryUserInfoInfo(String user_name,ClassInfo classObj,String name,String birthDate,String telephone) { 
    	Session s = factory.getCurrentSession();
    	String hql = "From UserInfo userInfo where 1=1";
    	if(!user_name.equals("")) hql = hql + " and userInfo.user_name like '%" + user_name + "%'";
    	if(null != classObj && !classObj.getClassNo().equals("")) hql += " and userInfo.classObj.classNo='" + classObj.getClassNo() + "'";
    ...
    /*计算总的页数和记录数*/
    @Transactional(propagation=Propagation.NOT_SUPPORTED)
    public void CalculateTotalPageAndRecordNumber(String user_name,ClassInfo classObj,String name,String birthDate,String telephone) {
        Session s = factory.getCurrentSession();
        String hql = "From UserInfo userInfo where 1=1";
        if(!user_name.equals("")) hql = hql + " and userInfo.user_name like '%" + user_name + "%'";
        if(null != classObj && !classObj.getClassNo().equals("")) hql += " and userInfo.classObj.classNo='" + classObj.getClassNo() + "'";
