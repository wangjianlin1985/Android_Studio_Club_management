...
public class ShetuanAction extends BaseAction {
    ...
    public String AddShetuan() {
        ...
        if(null != db_shetuan) {
            ctx.put("error",  java.net.URLEncoder.encode("该负责人账号已经存在!"));
            return "error";
        }
        try {
            /*处理社团logo上传*/
            ...
            ctx.put("message",  java.net.URLEncoder.encode("Shetuan添加成功!"));
            return "add_success";
            ...
            e.printStackTrace();
            ctx.put("error",  java.net.URLEncoder.encode("Shetuan添加失败!"));
            return "error";
        }
    }
    ...
    public String QueryShetuanOutputToExcel() { 
        ...
        String title = "Shetuan信息记录"; 
        String[] headers = { "负责人账号","社团名称","社团logo","成立日期","负责人","联系电话"};
		...
		*/
		...
		try { 
			...
			response.setHeader("Content-disposition","attachment; filename="+"Shetuan.xls");//filename是下载的xls的名，建议最好用英文 
    ...
    public String ModifyShetuan() {
        ...
        try {
            ...
            ctx.put("message",  java.net.URLEncoder.encode("Shetuan信息更新成功!"));
            return "modify_success";
        } catch (Exception e) {
            e.printStackTrace();
            ctx.put("error",  java.net.URLEncoder.encode("Shetuan信息更新失败!"));
            return "error";
       }
   }
    ...
    public String DeleteShetuan() {
        ...
        try { 
            ...
            ctx.put("message",  java.net.URLEncoder.encode("Shetuan删除成功!"));
            return "delete_success";
        } catch (Exception e) { 
            e.printStackTrace();
            ctx.put("error",  java.net.URLEncoder.encode("Shetuan删除失败!"));
            return "error";
        }
    }
